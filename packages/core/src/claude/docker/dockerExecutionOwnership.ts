...
import { resolveDockerRunHostPaths } from './dockerHostPath.js';
...
export function resolveExecutionArgs(
    ...
    const hostPathArgs = resolveDockerRunHostPaths(args);
    return addTaskAttemptLabelsToDockerArgs(hostPathArgs, taskId, attemptGeneration);
}
