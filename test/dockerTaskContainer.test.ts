    ...
    test('scopes child runs and host bind sources for named stacks while preserving default paths', () => {
        ...
        try {
            ...
            const scoped = resolveExecutionArgs('docker', [
                ...
                '-v', '/tmp/git-processor/worktrees/acme/repo/pr-17-followup:/home/node/workspace:rw',
            ...
            assert.ok(scoped.includes('/srv/propr-alt-temp/git-processor/worktrees/acme/repo/pr-17-followup:/home/node/workspace:rw'));
